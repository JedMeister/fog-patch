...
interface="eth0";
routeraddress="		option routers      192.168.1.254;";
#routeraddress="#	option routers      x.x.x.x;";
#plainrouter="192.168.1.102";
dnsaddress="	option domain-name-servers      192.168.1.1; ";
#dnsaddress="#	option domain-name-servers      x.x.x.x; ";
dnsbootimage="192.168.1.1";
password="";
osid="";
osname="";
dodhcp="y"; #'n' for no DHCP
bldhcp="1"; #'0' for no DHCP included
# new with version 0.24
snmysqluser="fog-user"
snmysqlpass="random-pass";
snmysqlhost="localhost";
# new with version 0.29
installlang="0"; #no internationalisation
